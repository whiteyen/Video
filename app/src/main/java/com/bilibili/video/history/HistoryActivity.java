...
public class HistoryActivity extends BaseActivity {
    ...
    private HistoryDBHelper mFavoriteDBHelper;
    ...
    protected void initView() {
        ...
        mFavoriteDBHelper = new HistoryDBHelper(this);
        mAlbumList = mFavoriteDBHelper.getAllData();
        mAdapter = new HistoryAdapter(this, mAlbumList);
    ...
    public void reloadData(){
        mAlbumList = mFavoriteDBHelper.getAllData();
        mAdapter = new HistoryAdapter(HistoryActivity.this, mAlbumList);
        mGridView.setAdapter(mAdapter);
