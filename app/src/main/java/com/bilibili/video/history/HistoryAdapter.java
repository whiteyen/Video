...
public class HistoryAdapter extends BaseAdapter {
    ...
    public HistoryAdapter(Context context, AlbumList albumList) {
        mAlbumList = albumList;
        mContext = context;
        mShowChecked = false;
        for(Album album:mAlbumList){
            mHistoryAlbums.add(new HistoryAlbum(album));
        }
    }
    ...
    @Override
    public HistoryAlbum getItem(int position) {
        return mHistoryAlbums.get(position);
    }
    public void OptionCheckedAllItem(boolean isSelected){
        for(HistoryAdapter.HistoryAlbum favoriteAlbum:mHistoryAlbums){
            favoriteAlbum.setChecked(isSelected);
        }
    }


    public List<HistoryAlbum> getFavoriteList() {
        return mHistoryAlbums;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        HistoryAlbum favoriteAlbum = getItem(position);
            ...
            if(!mShowChecked){
                ...
                holder.mContainer.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        setShowChecked(true);
                        mHistoryAlbums.get(position).setChecked(true);
    ...
    class HistoryAlbum{
        ...
        public HistoryAlbum(Album album){
            mAlbum = album;
            mIsChecked = false;
        }
