...
import com.bilibili.video.utils.MD5;
...
public class LetvApi  extends BaseSiteApi{
                ...
                try {
                    ...
                    if (albumJson.optJSONObject("body") != null) {
                        ...
                        if (albumJsonBody.optJSONObject("picCollections") != null){
                            ...
                            if (!TextUtils.isEmpty(jsonImg.optString("400*300"))) {
                                album.setHorImgUrl(StringEscapeUtils.unescapeJava(jsonImg.optString("400*300")));
                            }
                        }
    ...
    //取video相关信息
    public void onGetVideo( int pageSize, int pageNo,final Album album, final OnGetVideoListener listener) {
